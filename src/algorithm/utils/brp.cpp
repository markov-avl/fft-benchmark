...
static unsigned char reversed_bits[] = {
...
static uint64_t bit_reverse64(const uint64_t i) {
    return static_cast<uint64_t>(reversed_bits[i & 0xff]) << 56 |
           ...
           static_cast<uint64_t>(reversed_bits[i >> 16 & 0xff]) << 40 |
           static_cast<uint64_t>(reversed_bits[i >> 24 & 0xff]) << 32 |
           static_cast<uint64_t>(reversed_bits[i >> 32 & 0xff]) << 24 |
           static_cast<uint64_t>(reversed_bits[i >> 40 & 0xff]) << 16 |
           static_cast<uint64_t>(reversed_bits[i >> 48 & 0xff]) << 8 |
           static_cast<uint64_t>(reversed_bits[i >> 56 & 0xff]);
}
